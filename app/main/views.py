...
@main.route('/', methods=['GET', 'POST'])                           # 首页视图
def index():
    form = PostForm()
...
@main.route('/user/<username>')                                     # 用户资料视图
def user(username):
...
@main.route('/edit-profile', methods=['GET', 'POST'])               # 用户编辑资料视图
@login_required
def edit_profile():
...
@main.route('/edit-profile/<int:id>', methods=['GET', 'POST'])          # 管理员编辑资料视图
@login_required
@admin_required
